...
const navigation = [
  { name: 'الرئيسية', href: '/' },
  { name: 'الجامعات الخاصة', href: '/private-universities' },
  { name: 'الجامعات الحكومية', href: '/public-universities' },
      ...
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        <div className="flex lg:flex-1">
          <Link href="/" className="-m-1.5 p-1.5">
            <span className="text-2xl font-bold text-teal-600">EduGate</span>
          </Link>
        </div>
